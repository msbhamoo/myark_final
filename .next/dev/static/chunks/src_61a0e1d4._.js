...
_s1(StudentAuthProvider, "BZrfN3w/3NRtJZWjDQvvsyBEyxc=");
...
const AuthModal = ()=>{
    ...
    const { authModalOpen, hideAuthModal, authModalOptions, login, register } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$studentAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudentAuth"])();
    ...
    const handlePinConfirm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthModal.useCallback[handlePinConfirm]": async ()=>{
            ...
            if (result.success) {
                ...
                setTimeout({
                    "AuthModal.useCallback[handlePinConfirm]": ()=>setShowConfetti(false)
                }["AuthModal.useCallback[handlePinConfirm]"], 3000);
            } else {
                setState({
                    "AuthModal.useCallback[handlePinConfirm]": (s)=>({
                            ...s,
...
_s(AuthModal, "sNVtYHo+/rxtLibHy2VJaiPcl/0=", false, function() {
    return [
...
//# sourceMappingURL=src_61a0e1d4._.js.map