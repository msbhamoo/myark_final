      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          {opportunities.map((opp, index) => {
            const daysLeft = (mounted && opp.dates?.registrationEnd)
              ? Math.ceil((opp.dates.registrationEnd.getTime() - Date.now()) / (1000 * 60 * 60 * 24))
              : 0;
              ...
              >
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center text-xl">
                    {opp.type === 'competition' ? '�x� ' : opp.type === 'scholarship' ? '�x}' : '=�'}
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-[10px] uppercase font-bold tracking-wider">{opp.organizer}</p>
