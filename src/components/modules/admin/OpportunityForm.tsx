                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => handleChange("dates", { ...formData.dates, registrationStart: new Date(e.target.value) })}
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => handleChange("dates", { ...formData.dates, registrationEnd: new Date(e.target.value) })}
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => handleChange("dates", { ...formData.dates, eventDate: new Date(e.target.value) })}
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                ...
                                {feeType === "paid" && (
                                    ...
                                    <div>
                                        ...
                                        <Label htmlFor="fees">Registration Fee (ï¿½ï¿½)</Label>
