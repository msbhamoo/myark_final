  ...
  return (
    <section className="w-full bg-[#0a0f0a] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-20%] left-[30%] w-[800px] h-[800px] rounded-full bg-emerald-500/[0.08] blur-[140px] animate-pulse" style={{ animationDuration: '8s' }}></div>
        <div className="absolute bottom-[-10%] right-[5%] w-[600px] h-[600px] rounded-full bg-green-400/[0.06] blur-[120px] animate-pulse" style={{ animationDuration: '12s' }}></div>
        <div className="absolute top-[15%] left-[-10%] w-[500px] h-[500px] rounded-full bg-emerald-600/[0.04] blur-[100px]"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center min-h-[350px] md:min-h-[500px] py-10 md:py-16">
          ...
          <div className="flex flex-col items-start text-left max-w-xl z-10">
            ...
            <h1 className="text-[24px] sm:text-[32px] md:text-[42px] lg:text-[48px] font-heading font-extrabold leading-[1.1] text-[#f0ede5] tracking-tight mb-4">
              ...
              <span className="bg-gradient-to-r from-[#4ade80] to-[#22c55e] bg-clip-text text-transparent italic">One platform.</span>
            </h1>
              ...
              <div className="flex gap-3 animate-marquee group-hover:[animation-play-state:paused]">
                {[...categories, ...categories].map((cat, i) => (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/[0.03] border border-white/[0.06] text-[12px] font-bold text-[#8a8a84] hover:bg-white/[0.08] hover:border-[#4ade80]/40 hover:text-white transition-all whitespace-nowrap shrink-0 shadow-sm"
                  >
            ...
            <div className="flex flex-wrap items-center gap-x-8 gap-y-3 pt-6 border-t border-white/[0.05] w-full">
              {[
                ...
                <div key={i} className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#4ade80]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d={item.icon} />
                  </svg>
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#4ade80]/[0.05] blur-[100px] rounded-full"></div>
            <HeroFloatingCards />
          </div>
