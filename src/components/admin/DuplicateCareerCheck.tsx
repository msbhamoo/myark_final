...
import { checkDuplicateCareer } from '@/app/admin/careers/actions';

export function DuplicateCareerCheck({ name, excludeId }: { name: string, excludeId?: string }) {
  ...
  useEffect(() => {
    const timer = setTimeout(async () => {
      ...
      setLoading(true);
      try {
        const result = await checkDuplicateCareer(name, excludeId);
