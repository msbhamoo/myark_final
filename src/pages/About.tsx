                ...
                <section className="container-tight mt-32 px-4">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                That's where <span className="font-bold text-foreground">Myro</span> comes in. Our clever mascot was born from the idea that every student needs a guide—a partner who makes the journey exciting, rewards progress, and never lets a good opportunity go to waste.
                            </p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, scale: 0.9 }}
