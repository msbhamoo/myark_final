            ...
            <div className="min-h-screen bg-background">
                ...
                <div className="flex items-center justify-center min-h-[80vh] px-4">
                    <div className="glass-card p-12 text-center max-w-md">
                        ...
                        <Button onClick={() => navigate("/")} className="w-full">Explore Others</Button>
                    </div>
                </div>
            </div>
        );
            ...
            <section className="relative min-h-screen md:min-h-[90vh] overflow-hidden">
                ...
                <div className="relative z-30 p-4 md:p-6">
                    <div className="max-w-7xl mx-auto flex items-center justify-between">
                        <motion.button whileHover={{ x: -4 }} onClick={() => navigate("/")} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-white text-sm font-bold hover:bg-white/10 transition-colors">
