                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
                        <div>
                            ...
                            <h1 className="font-display text-4xl md:text-5xl font-bold">
                                {categoryFilter ? `${categoryFilter} Qusts` : "Explore Everything 🔭"}
                            </h1>
                        </div>
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0">
                            ...
                            <Button
                                ...
                                size="sm"
                                onClick={() => window.location.href = '/explore?category=scholarship'}
                            >
                                Scholarships
                            </Button>
                            <Button
                                ...
                                size="sm"
                                onClick={() => window.location.href = '/explore?category=competition'}
                            >
                                Competitions
                            </Button>
                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-32 glass-card rounded-[40px] border-dashed">
                            <p className="text-xl text-muted-foreground font-medium">No quests found here right now. Check back soon! 🕵️‍♂️</p>
                        </div>
                    )}
                </div>
            </main>
