  ...
  return (
    <div className='space-y-8'>
      <section className='rounded-2xl border border-border/60 dark:border-white/10 bg-card/80 dark:bg-white/5 p-6 backdrop-blur'>
        <h2 className='text-lg font-semibold text-foreground dark:text-white'>{editingId ? 'Edit city' : 'Create city'}</h2>
        <form onSubmit={handleSubmit} className='mt-6 grid grid-cols-1 gap-4 md:grid-cols-2'>
          <div className='space-y-2'>
            <label className='text-sm font-medium text-foreground dark:text-white' htmlFor='city-name'>
              Name *
            </label>
            <Input
              id='city-name'
          ...
          <div className='space-y-2'>
            <label className='text-sm font-medium text-foreground dark:text-white' htmlFor='city-state'>
              State *
            </label>
            <select
              id='city-state'
      ...
      <section className='rounded-2xl border border-border/60 dark:border-white/10 bg-card/80 dark:bg-white/5 p-6 backdrop-blur'>
        <div className='flex items-center justify-between'>
          <h2 className='text-lg font-semibold text-foreground dark:text-white'>Existing Cities</h2>
            ...
            <TableBody>
              ...
              {items.map((item) => (
                <TableRow key={item.id} className='hover:bg-card/80 dark:bg-white/5'>
                  ...
                  <TableCell className='text-muted-foreground'>{states.find(s => s.id === item.stateId)?.name || 'N/A'}</TableCell>
