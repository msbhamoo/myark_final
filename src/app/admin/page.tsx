  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card className="bg-white/5 p-6 backdrop-blur border-white/10">
          <p className="text-sm text-slate-300">Total Opportunities</p>
          <p className="mt-2 text-3xl font-semibold text-white">{opportunitiesCount}</p>
        ...
        <Card className="bg-white/5 p-6 backdrop-blur border-white/10">
          ...
          <p className="mt-2 text-3xl font-semibold text-white">{schoolsCount}</p>
        ...
        <Card className="bg-white/5 p-6 backdrop-blur border-white/10">
          ...
          <p className="mt-2 text-3xl font-semibold text-white">{usersCount}</p>
      ...
      <Card className="bg-white/5 p-6 backdrop-blur border-white/10">
        ...
        <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-slate-300">
          ...
          <li>Extend API endpoints under <code className="rounded bg-white/10 px-1.5">/api/admin</code> to cover create/update/delete operations.</li>
