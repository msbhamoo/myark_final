...
export default async function CareerDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="bg-[#f9fafb] dark:bg-gray-950 min-h-screen pb-20 font-sans text-gray-900 dark:text-gray-100 selection:bg-[#70A5FF]/30 transition-colors">
      {/* SEO SCHEMAS */}
      <script
      ...
      <section className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 pt-24 pb-16 relative overflow-hidden transition-colors">
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#f0fdf4]/60 dark:bg-blue-500/10 blur-3xl rounded-full translate-y-1/2 -translate-x-1/4 pointer-events-none"></div>
        ...
        <div className="container-main max-w-[1240px] px-4 relative z-10">
            <nav className="flex items-center gap-2 mb-8 text-[12px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                <Link href="/careers" className="hover:text-[#1B4332] dark:hover:text-blue-400 transition-colors">Careers Directory</Link>
                <span>/</span>
                <Link href={`/careers?category=${encodeURIComponent(career.category)}`} className="hover:text-[#1B4332] dark:hover:text-blue-400 transition-colors">{career.category}</Link>
                <span>/</span>
                <span className="text-[#1B4332] dark:text-blue-300 truncate max-w-[200px]">{career.name}</span>
            </nav>
            
            <div className="flex flex-wrap gap-3 mb-6">
                <span className="bg-[#1B4332]/5 dark:bg-blue-500/10 border border-[#1B4332]/10 dark:border-blue-500/20 text-[#1B4332] dark:text-blue-400 text-[11px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest flex items-center gap-2 shadow-sm">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                    {career.stream_required}
                </span>
                <span className="bg-[#70A5FF]/10 dark:bg-blue-800/20 border border-[#70A5FF]/20 dark:border-blue-700/30 text-[#166534] dark:text-blue-400 text-[11px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest shadow-sm">
                    {career.category}
                </span>
                {isRare && (
            ...
            <h1 className="text-[40px] md:text-[56px] font-heading font-extrabold text-[#1B4332] dark:text-blue-50 leading-[1.05] tracking-tight mb-5 max-w-4xl">
                {career.name}
            </h1>
                ...
                {[
                    ...
                    <div key={i} className="bg-gray-50/80 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 p-5 rounded-[24px] flex flex-col items-start hover:shadow-md transition-shadow">
                        <div className="w-8 h-8 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center mb-3">
                            <svg className="w-4 h-4 text-[#1B4332] dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={stat.icon} /></svg>
                        </div>
          ...
          <div className="lg:col-span-8 space-y-24">
            ...
            <div id="what-you-do">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-[28px] md:text-[32px] font-heading font-extrabold text-[#1B4332] dark:text-blue-400">
            ...
            <div id="is-this-for-you">
                <div className="flex items-center gap-4 mb-8">
                    <div className="w-12 h-12 rounded-2xl bg-[#f0fdf4] dark:bg-blue-900/40 text-[#166534] dark:text-blue-400 flex items-center justify-center font-heading font-black text-xl">2</div>
                    <h2 className="text-[28px] md:text-[32px] font-heading font-extrabold text-[#1B4332] dark:text-blue-400">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Pros Card */}
                    <div className="bg-white dark:bg-gray-900 border-2 border-blue-100 dark:border-blue-900/30 rounded-[32px] p-8 shadow-sm hover:shadow-lg hover:shadow-blue-500/5 dark:hover:shadow-blue-500/10 transition-all">
                        <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center mb-6">
                        ...
                        <h4 className="text-[#166534] dark:text-blue-400 font-extrabold text-[18px] mb-4">You&apos;ll Love This If...</h4>
                            ...
                            {career.is_this_for_you.split('\n').filter((l: string) => l.toLowerCase().includes('love this') || l.length > 5).map((l: string, i: number) => {
                                ...
                                return (
                                    <li key={i} className="flex gap-3 text-[15px] text-gray-600 dark:text-gray-300 font-medium leading-relaxed">
                                        <svg className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                        <span>{text}</span>
                                    </li>
                                );
                            })}
            ...
            <div id="salary">
                <div className="flex items-center gap-4 mb-8">
                    <div className="w-12 h-12 rounded-2xl bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center font-heading font-black text-xl">5</div>
                    <h2 className="text-[28px] md:text-[32px] font-heading font-extrabold text-[#1B4332] dark:text-blue-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-px bg-gray-100 dark:bg-gray-800 p-px rounded-3xl overflow-hidden relative z-10">
                        {[
                            ...
                            <div key={i} className="bg-white dark:bg-gray-900 p-6 md:p-8 flex flex-col justify-center text-center">
                                <div className="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 mx-auto flex items-center justify-center mb-4">
                                ...
                                <span className="text-[20px] md:text-[24px] font-black text-[#15803d] dark:text-blue-400">{s.val}</span>
                            </div>
                        ))}
                    </div>
          ...
          <div className="lg:col-span-4 hidden lg:block">
            <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-8 rounded-[32px] shadow-lg shadow-gray-200/50 dark:shadow-black/50">
                    <h4 className="text-[18px] font-heading font-extrabold text-[#1B4332] dark:text-blue-400 mb-6 flex items-center gap-2">
                        <svg className="w-5 h-5 text-[#70A5FF] dark:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        Career DNA
                    </h4>
                ...
                {/* PARENT CTA BOX */}
                <div className="bg-[#1B4332] dark:bg-blue-950/80 dark:border dark:border-blue-900 text-white dark:text-blue-50 p-8 rounded-[32px] shadow-md relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-[13px] text-[#e0f2fe] dark:text-blue-100/80 mb-6 leading-relaxed">Save this career to your profile and get notified about matching internships and entrance exam dates.</p>
                        
                        <button className="w-full h-12 bg-[#70A5FF] dark:bg-blue-500 text-[#1B4332] dark:text-blue-950 font-black rounded-xl text-[14px] shadow-lg shadow-[#70A5FF]/20 hover:scale-[1.02] transition-transform">
                            Save to My Profile
                        </button>
                    </div>
                </div>
      ...
      <section className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-20 mt-10 transition-colors">
          <div className="container-main max-w-[1240px] px-4">
              <div className="flex flex-col items-center text-center mb-12">
                  <h3 className="text-[28px] md:text-[36px] font-heading font-extrabold text-[#1B4332] dark:text-blue-400 mb-3">Keep Exploring</h3>
